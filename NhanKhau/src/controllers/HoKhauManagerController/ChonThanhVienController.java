 ...
 * @author Hai
 */
public class ChonThanhVienController {
    ...
    private final String[] COLUMNS = {"ID", "Họ tên", "Ngày sinh", "Giới tính"};
    private JFrame parentJFrame;
    private JTable table;

    public ChonThanhVienController(JPanel jpnView, JTextField jtfSearch) {
    ...
    public ChonThanhVienController(JPanel jpnView, JTextField jtfSearch, JButton locButton) {
        this.jpnView = jpnView;
        this.jtfSearch = jtfSearch;
        this.locButton = locButton;
        classTableModel = new TableModelHoKhau();
        this.nhanKhauService = new NhanKhauService();
        this.listNhanKhauBeans = this.nhanKhauService.searchKhongPhaiChuHo("", "");
        locButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                listNhanKhauBeans = nhanKhauService.searchKhongPhaiChuHo(key.trim(), "");
                setDataTable();
            }
        });
        refreshData();
    ...
    public ChonThanhVienController() {
    }
...
//        });
    ...
    public void setDataTable() {
        ...
        DefaultTableModel model = classTableModel.setTableNhanKhau(listNhanKhauBeans, COLUMNS);
