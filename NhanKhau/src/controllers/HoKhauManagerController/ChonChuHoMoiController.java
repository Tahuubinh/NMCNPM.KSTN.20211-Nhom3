 ...
 * @author Hai
 */
public class ChonChuHoMoiController {
    ...
    public ChonChuHoMoiController(JPanel jpnView, JTextField jtfSearch) {
    ...
    public ChonChuHoMoiController(JPanel jpnView, JTextField jtfSearch, JButton locButton) {
        this.jpnView = jpnView;
        this.jtfSearch = jtfSearch;
