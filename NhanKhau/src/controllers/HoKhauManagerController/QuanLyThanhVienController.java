...
public class QuanLyThanhVienController {
    ...
    public QuanLyThanhVienController(JPanel jpnView, JTextField jtfSearch) {
    ...
    public QuanLyThanhVienController(JPanel jpnView, JTextField jtfSearch, JButton locButton, int id_ho_khau) {
        this.jpnView = jpnView;
        this.jtfSearch = jtfSearch;
...
//    	String key = jtfSearch.getText();
    	//String keyDiachiString = diachiSearchtextField.getText();
        listNhanKhauBeans = nhanKhauService.searchThanhVienCuaHo(this.id_ho_khau);
        setDataTable();
    }
