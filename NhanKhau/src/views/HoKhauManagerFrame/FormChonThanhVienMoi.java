 ...
 * @author Hai
 */
public class FormChonThanhVienMoi extends javax.swing.JFrame {
     ...
     */
    public FormChonThanhVienMoi(NhanKhauBean nhanKhauBean, JFrame parentJframe) {
    	setTitle("Chọn thành viên mới");
        initComponents();
