...
//            obj[3] = item.getDiaChiHienNay();
    ...
    public DefaultTableModel setTableNhanKhauXoa(List<NhanKhauModel> listItem, String[] listColumn) {
        final int columns = listColumn.length;
        DefaultTableModel dtm = new DefaultTableModel()  {
            @Override
            public boolean isCellEditable(int row, int column) {
...
//            obj[3] = item.getDiaChiHienNay();
    ...
    public DefaultTableModel setTableTam(List<NhanKhauModel> listItem, String[] listColumn) {
        final int columns = listColumn.length;
        DefaultTableModel dtm = new DefaultTableModel()  {
            @Override
            public boolean isCellEditable(int row, int column) {
        ...
        listItem.forEach((NhanKhauModel item) -> {
            ...
            obj[1] = item.getHoTen();
            obj[2] = item.getNamSinh();
            obj[3] = item.getNgayChuyenDen();
            obj[4] = item.getNgayChuyenDi();
