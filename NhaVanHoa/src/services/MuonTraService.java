...
public class MuonTraService {
    ...
    public List<MuonTraBean> statisticMuonTra(String tenNguoiMuon, String lienHe, String tuNgay, String denNgay) {
        List<MuonTraBean> list = new ArrayList<>();
        //viết truy vấn
        return list;
    }
     ...
     */
    public List<MuonTraBean> search(String tenNguoiMuon, String lienHe, String tuNgay, String denNgay) {
        List<MuonTraBean> list = new  ArrayList<>();
        return list;
    }
